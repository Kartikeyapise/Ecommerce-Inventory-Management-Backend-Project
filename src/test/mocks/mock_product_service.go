...
func (m *MockProductServiceInterface) AddProducts(arg0 string, arg1 []model.Product) error {
	m.ctrl.T.Helper()
...
func (mr *MockProductServiceInterfaceMockRecorder) AddProducts(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddProducts", reflect.TypeOf((*MockProductServiceInterface)(nil).AddProducts), arg0, arg1)
}

// BuyProduct mocks base method.
func (m *MockProductServiceInterface) BuyProduct(arg0 model.Sales) (*model.Product, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductServiceInterfaceMockRecorder) BuyProduct(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuyProduct", reflect.TypeOf((*MockProductServiceInterface)(nil).BuyProduct), arg0)
}

// GetProductById mocks base method.
func (m *MockProductServiceInterface) GetProductById(arg0 string) (*model.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductServiceInterface) GetProducts() ([]model.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductServiceInterface) GetRecommendedProducts(arg0 string) ([]model.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRecommendedProducts", arg0)
	ret0, _ := ret[0].([]model.Product)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockProductServiceInterfaceMockRecorder) GetRecommendedProducts(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRecommendedProducts", reflect.TypeOf((*MockProductServiceInterface)(nil).GetRecommendedProducts), arg0)
}
